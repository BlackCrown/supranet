        ...
        <div className={styles.corpo}>
          <section className={styles.comercial}>
            ...
            <p className={styles.txt1}>
              <strong>SupraNet</strong> é uma <strong>empresa</strong> de
              internet dedicada a fornecer soluções de conectividade de
              <strong>alta qualidade</strong> para o mercado comercial e
              empresarial.
            </p>
            <p className={styles.txt2}>
              Com um enfoque em planos acessíveis e personalizados, a
              <strong>SupraNet</strong> está comprometida em oferecer serviços
              que atendam às necessidades de ,<strong>empresas</strong> de todos
              os tamanhos, desde startups até grandes corporações.
            </p>
          </section>
